...
<p align="center">
  <em>기능 구현을 넘어, 실제 운영 환경에서 안정적으로 동작하는 시스템을 만드는 데 관심이 많은 백엔드 · 웹 개발자입니다.</em>
</p>
...
- 🧠 문제를 만나면 로그 · 설정 · 서버 · 외부 연동을 함께 확인하며 원인을 단계적으로 좁히는 방식을 중요하게 생각합니다.
...
**리스크제로 · 개발팀** &nbsp;|&nbsp; 2021.05 – 2023.08 (약 2년 4개월)

웹 / 백엔드 개발을 중심으로 건설안전관리 · 관제 시스템을 개발했습니다. 단순 기능 구현을 넘어 서버 구성, 외부 장비 연동, 데이터 흐름과 오류 원인까지 함께 확인하며 시스템이 실제 환경에서 안정적으로 동작하도록 했습니다.
