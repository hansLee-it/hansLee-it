<!--
  이 파일은 GitHub 프로필 README입니다 (hansLee-it/hansLee-it).
  현재 기본 언어: 한국어

  ▸ 나중에 기본 언어를 영어로 바꾸려면:
    1) 이 파일(README.md, 한국어)을 README.ko.md 로 이름 변경
    2) README.en.md(영어)를 README.md 로 이름 변경
    3) 각 파일 상단의 "Language" 전환 링크 경로를 서로 맞게 수정
    => 프로필에는 항상 README.md 가 표시되므로, 표시되는 언어만 바뀝니다.
-->
...
<h1 align="center">안녕하세요, 이현수입니다 👋</h1>

<p align="center">
  <em>특정 분야에 얽매이지 않고 필요한 언어와 도구를 골라 쓰는 개발자입니다.<br/>오류 하나까지 그냥 넘기지 못하는 꼼꼼함과, 더 나은 방법을 끊임없이 고민하는 아이디어로 문제를 풀어갑니다.</em>
</p>
...
- 🧰 메인 기술은 **Java · Spring Boot** 입니다.
- ☁️ 예전에는 **서버 구성과 클라우드 인프라 · 배포**에 관심이 많았습니다.
- 🤖 요즘은 **AI 개발**에 푹 빠져 있습니다. 특히 **LLM 기반 에이전트 · 자동화**와 **운영 자동화에 AI를 접목하는 AIOps**에 관심이 많습니다.
- 🧩 한 분야나 언어에 머무르지 않고, 필요하면 새로운 스택도 직접 골라 써 보는 편입니다.
...
<img height="165" src="https://github-readme-stats-sigma-five.vercel.app/api?username=hansLee-it&show_icons=true&hide_border=true&count_private=true&bg_color=00000000&title_color=2563eb&icon_color=2563eb&text_color=808080" alt="Hyunsoo Lee's GitHub stats" />
<img height="165" src="https://github-readme-stats-sigma-five.vercel.app/api/top-langs/?username=hansLee-it&layout=compact&hide_border=true&bg_color=00000000&title_color=2563eb&text_color=808080" alt="Top languages" />
...
<div align="center">
  <sub>📫 함께 일하고 싶으시다면 언제든 <a href="mailto:it.hans.lee@gmail.com">it.hans.lee@gmail.com</a> 으로 연락 주세요.</sub>
</div>
