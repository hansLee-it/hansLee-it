...
- ☁️ 예전에는 **서버 구성과 클라우드 인프라 · 배포**에 푹 빠져 있었고, 그 과정에서 **AWS Certified Solutions Architect – Associate**를 취득했습니다.
- 🤖 요즘 가장 흥미를 느끼는 분야는 **AI 개발, 특히 AIOps**(AI를 개발 · 운영에 접목하는 것)입니다.
- 🧩 한 분야나 언어에 머무르지 않고, 필요하면 새로운 스택도 직접 골라 써 보는 편입니다.
- 🧠 개발할 때는 **나만의 규칙과 일관성을 정해 두는 것**을 좋아합니다. 다만 AI와 함께 개발하는 지금은, 코드를 예쁘게 다듬기보다 **의도와 구조가 잘 드러나고 오류 없이 동작하는 코드**에 더 무게를 둡니다.
